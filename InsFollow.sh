#!/bin/bash
# insfollow v3.0
# recoded by: Abir Rahman 
# github.com/D4rk-B0y/insfollow
...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92m𝐀𝐁𝐈𝐑 X 𝐌𝐀𝐈𝐒𝐇𝐀"
